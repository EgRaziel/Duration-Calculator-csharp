...
<img src="./CalculadoraDuracaoCSharp/Images/Menu.png" alt="Menu" width="400" style="mas-width: 100%">
...
<img src="./CalculadoraDuracaoCSharp/Images/InitialD.png" alt="InitialDuration" width="400" style="mas-width: 100%">
...
<img src="./CalculadoraDuracaoCSharp/Images/FinalD.png" alt="FinalDuration" width="400" style="mas-width: 100%">
...
<img src="./CalculadoraDuracaoCSharp/Images/ResultD.png" alt="ResultDuration" width="400" style="mas-width: 100%">
<img src="./CalculadoraDuracaoCSharp/Images/NewCalc.png" alt="NewCalc" width="400" style="mas-width: 100%">

### It will also ask the type of the calculation. If you want to perform a new _Sum_, or a new _Subtract_.
<img src="./CalculadoraDuracaoCSharp/Images/NewCalcType.png" alt="NewCalcType" width="400" style="mas-width: 100%">

### When asked if you want to **perform a new calc**, if the answer is _n_ (No), the program will finish with a thanks message.
<img src="./CalculadoraDuracaoCSharp/Images/FinalMessage.png" alt="FinalMessage" width="400" style="mas-width: 100%">